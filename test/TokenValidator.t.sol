...
contract TokenValidatorTest is Test {
    ...
    function testSingleBaseValidateTokenHasFeeOnTransfer_V2() public {
        address token = 0x3CB20d96E866D128BC469a6e66505d46D7F9BaBa;
        address[] memory tokens = new address[](1);
        tokens[0] = token;

        address baseToken = 0x55d398326f99059fF775485246999027B3197955; // usdt

        uint256 amountToBorrow = 10000;
        TokenFees[] memory fees = validator.batchValidate(tokens, baseToken, amountToBorrow, 10000000);
    ...
    function testBulkBaseValidateTokenHasFeeOnTransfer_V2() public {
        address token = 0x3CB20d96E866D128BC469a6e66505d46D7F9BaBa;
        address[] memory tokens = new address[](1);
        tokens[0] = token;
    ...
    function testSingleBaseValidateTokenNoPairFound_V2() public {
        address token = 0x1c3995a53087BF8fC7458E56868Ca87CbCB57D07;
        address[] memory tokens = new address[](1);
        tokens[0] = token;

        address baseToken = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // wbnb

        uint256 amountToBorrow = 10000;
        TokenFees[] memory fees = validator.batchValidate(tokens, baseToken, amountToBorrow, 1000000);
    ...
    function testBulkBaseValidateTokenNoPairFound_V2() public {
        address token = 0x1c3995a53087BF8fC7458E56868Ca87CbCB57D07;
        address[] memory tokens = new address[](1);
        tokens[0] = token;
    ...
    function testSingleBaseValidateTokenHasFeeOnTransfer_V3() public {
        ...
        uint256 amountToBorrow = 10000;
        TokenFees[] memory fees = validator.batchValidateV3(tokens, baseToken, amountToBorrow, 1000000);
    ...
    function testBulkBaseValidateTokenHasFeeOnTransfer_V3() public {
        address token = 0x3ADE350e05F631f946B6d2B1a2deAAF95DCB243a;
        address[] memory tokens = new address[](1);
        tokens[0] = token;
    ...
    function testSingleBaseValidateTokenNoPairFound_V3() public {
        address token = 0x1c3995a53087BF8fC7458E56868Ca87CbCB57D07;
        address[] memory tokens = new address[](1);
        tokens[0] = token;
    ...
    function testBulkBaseValidateTokenNoPoolFound_V3() public {
        address token = 0x1c3995a53087BF8fC7458E56868Ca87CbCB57D07;
        address[] memory tokens = new address[](1);
        tokens[0] = token;
